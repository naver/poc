...
# COCO classes not present in Cityscapes (72)
# All COCO classes except ['person', 'bicycle', 'car', 'motorcycle', 'bus', 'truck', 'traffic light', 'stop sign']
non_cs_objects = ['airplane', 'apple', 'backpack', 'banana', 'baseball bat', 'baseball glove', 'bear', 'bed', 'bench',
                  'bird flying', 'boat', 'book', 'bottle', 'bowl', 'broccoli', 'cake', 'carrot', 'cat', 'cell phone', 'chair',
                  'clock', 'couch', 'cow', 'cup', 'dining table', 'dog', 'donut', 'elephant', 'fire hydrant', 'fork',
                  'frisbee', 'giraffe', 'hair drier', 'handbag', 'horse', 'hot dog', 'keyboard', 'kite', 'knife', 'laptop',
                  'microwave', 'mouse', 'orange', 'oven', 'parking meter', 'pizza', 'potted plant', 'refrigerator', 'remote',
                  'sandwich', 'scissors', 'sheep', 'sink', 'skateboard', 'skis', 'snowboard', 'spoon', 'sports ball', 
                  'suitcase', 'surfboard', 'teddy bear', 'tennis racket', 'tie', 'toaster', 'toilet', 'toothbrush', 'train',
                  'tv', 'umbrella', 'vase', 'wine glass', 'zebra']

objects += non_cs_objects
    
results_root = '/gfs-ssd/project/clara/data-new/Cityscapes_SD_aug/cs_synth_coco_classes/'
